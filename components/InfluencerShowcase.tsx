...
const Card: React.FC<{ item: Influencer }> = ({ item }) => (
  <article className="inline-block px-4 w-[320px] md:w-[420px] flex-shrink-0">
    <div className="bg-white rounded-2xl border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group">
      ...
      <div className="p-6">
        <div className="flex items-center justify-between gap-2 mb-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="overflow-hidden min-w-0">
              <p className="text-sm font-black text-jp-navy truncate">{item.name}</p>
              <p className="text-[11px] text-gray-500 font-medium truncate">{item.handle}</p>
            </div>
          </div>
        ...
        <div className="relative pt-2 min-h-[60px]">
          ...
          <p className="text-gray-700 font-bold text-sm md:text-base leading-relaxed italic relative z-10 line-clamp-2 break-words">
            {item.quote}
          </p>
        </div>
