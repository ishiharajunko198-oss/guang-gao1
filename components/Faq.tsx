...
const Faq: React.FC = () => {
  ...
  const faqs: FaqItem[] = [
    ...
    },
    {
      ...
      answer: "セラースプライトは、主にパソコンのブラウザでご利用いただくツールです。拡張機能はChrome、Edge、Firefox、Safariなどのブラウザに無料で対応しています。2024年以降、iPad・Macでのご利用もサポート可能。【ご注意】誠に恐れ入りますが、現在スマートフォンには対応しておりません。"
    },
    {
